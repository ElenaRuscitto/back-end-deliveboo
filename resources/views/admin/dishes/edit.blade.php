...
<div class="container">
    ...
    <form id="dish-form" action="{{ route('admin.dishes.update', ['dish'=> $dish]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group pt-3">
            ...
            <img class=" w-25 mt-2" id="thumb" :src="{{ asset('storage/uploads/' . $dish->image) }}"
                  >
